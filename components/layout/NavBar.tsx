  ...
  const drawer = (
    <Box sx={{ textAlign: "center", mt: 4 }}>
      ...
      <List sx={{ mt: 2 }}>
          ...
          <ListItem key={item.text} disablePadding>
            <ListItemButton component={Link} href={item.path} sx={{ textAlign: "center" }}>
              <ListItemText
                primary={item.text}
                primaryTypographyProps={{
                  sx: { color: "#4D4A4A", fontWeight: 800 },
                }}
              />
            </ListItemButton>
          </ListItem>
        ...
        {/* لوحة التحكم - بدون حماية */}
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/admin" sx={{ textAlign: "center" }}>
            <ListItemText
              primary="لوحة التحكم"
              primaryTypographyProps={{
                sx: { color: "#0E5F4F", fontWeight: 800 },
              }}
            />
          </ListItemButton>
        </ListItem>
    ...
    <Box sx={{ display: "flex", justifyContent: "center", pt: 5 }}>
      ...
      >
        <Toolbar sx={{ minHeight: "98px", px: 4, justifyContent: "space-between" }}>
          ...
          <IconButton
            onClick={handleDrawerToggle}
            sx={{ display: { sm: "none" }, color: "var(--color-text-primary)" }}
          >
            <MenuIcon />
          </IconButton>
          ...
          <Box sx={{ display: { xs: "none", sm: "flex" }, gap: 1, alignItems: "center" }}>
            ...
            {!isLoggedIn ? (
              ...
              <Link href="/profile">
                ...
                >
                  <AccountCircleOutlinedIcon sx={{ color: "#00372C" }} />
                </Box>
              </Link>
            )}
          </Box>
